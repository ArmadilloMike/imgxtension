chrome.storage.local.get(['showMod'], result => {
    const setting = result.showMod ?? false; 


    if (typeof window !== "undefined" && window.location.href.includes("imgflip.com/user")  && setting == true) {
